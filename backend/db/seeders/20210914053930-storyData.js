...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('Stories', [
      {
        imageUrl: 'https://unsplash.com/photos/b1-JDjIq_00',
        authorId: 1,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/x_JbZ6bFg1Q',
        authorId: 2,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/KHBvwAnWFmc',
        authorId: 3,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/Xwx6eYL2_H8',
        authorId: 4,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/ZgcB6XB4moQ',
        authorId: 1,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/Q-dWFHWaE6c',
        authorId: 2,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/L5dmylYG6qc',
        authorId: 3,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/lz_VB9yEc_c',
        authorId: 4,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/0iNLhORjMGM',
        authorId: 1,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/l4LGgESBG9Q',
        authorId: 2,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/PUTVh0Z_qNQ',
        authorId: 3,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/5PVXkqt2s9k',
        authorId: 3,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/73pyV0JJOmE',
        authorId: 1,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/T-0EW-SEbsE',
        authorId: 2,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/U3aF7hgUSrk',
        authorId: 3,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/jd0hS7Vhn_A',
        authorId: 1,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/0h3Emf2YLKg',
        authorId: 2,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/915UJQaxtrk',
        authorId: 3,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/aH9Uskj8XTU',
        authorId: 1,
      ...
      {
        imageUrl: 'https://unsplash.com/photos/f5KQq4Wfxg8',
        authorId: 2,
